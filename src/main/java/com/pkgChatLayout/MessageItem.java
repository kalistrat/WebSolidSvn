...
public  MessageItem (String vResContactImage, String vMessageText, String vContactName, String vMessageDate, VerticalLayout vLinkLayout, Boolean vIncomingMesage)
{
...
if (vResContactImage!=null)
{
ContactImage.setSource(new ThemeResource(vResContactImage));
ContactImage.setWidth(60, Unit.PIXELS);
ContactImage.setHeight(60, Unit.PIXELS);
}
else
